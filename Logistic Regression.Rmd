...
subtitle: "2015 migration crisis in Europe and xenophobic attitudes: a cross national comparison"
...
imbgeco <11 ~ 0)) %>%
  mutate(AGE = case_when(agea< 30 ~ "Age 18-29",
agea< 60 ~ "Age 30-59",
agea< 80 ~ "Age 60-79")) %>%
...
I restricted the data sets to Spain, France, Germany, and Italy, and combined the Round 6, 8 and 9 datasets. The total sample comprises 26,062 respondents. After deleting respondents with missing information on the variables of analysis, the final analytical sample decreased to 24,612, a 6% reduction from the total sample.
